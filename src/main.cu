...
int main(int argc, char **argv) {
  ...
  cv::Mat resizedImgOut(ro_h, ro_w,
                        CV_32FC1);  // mOut will be a grayscale image, 1 layer
  ...
  /*transfer(resizedTemplate, pResizedObservation, qTemplate, rt_w, rt_h, ro_w,
   * ro_h,*/
  /*resizedImOut);*/
  ...
  transfer(resizedImOut, pRegistered, ro_w, ro_h, resizedTemplate, qTemplate,
           rt_w, rt_h);
